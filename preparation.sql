...
PUT 'file://D:/Documentos Pessoais/Desafios/clear_strategy/yds_data.csv' @INTERNAL_STAGES.CS_EVENTS;
...
INSERT INTO CS_CHALLENGE_DB.CS_DATA.GAMES_SILVER (
    SELECT
        ...
        LAT_LNG,
        -- CASE
        --     WHEN GAME_SEASON IS NULL THEN
        --         TO_CHAR(EXTRACT(YEAR FROM DATE_OF_GAME)) || '-' || SUBSTR(EXTRACT(YEAR FROM DATE_OF_GAME) + 1, -2)
        --     ELSE GAME_SEASON
        -- END GAME_SEASON,
        DATE_OF_GAME,
        HOME_AWAY,
    ...
    WHERE GAME_SEASON IS NOT NULL OR DATE_OF_GAME IS NOT NULL
);